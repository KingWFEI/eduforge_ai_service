...
class LearningResource(Base):
    ...
    section_id = Column(String(64), ForeignKey("course_chapters.id"), index=True, nullable=True)
    generation_scope = Column(String(30), nullable=True)
    ...
    generation_task_id = Column(String(64), nullable=True, index=True)
...
class ResourceGenerationTask(Base):
    ...
    generation_scope = Column(String(30), nullable=True)
    knowledge_point_ids_json = Column(JSON, nullable=True)
